...
def main(args):
    ...
    model = SentenceTransformer('/home/xiongzj/myProjects/KCQRL-main/kc_annotation/all-mpnet-base-v2', device=device)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--path_kc_questions_map', type=str, help="Path to the KC questions map JSON file.", 
                        default='/home/xiongzj/myProjects/KCQRL-main/data/moocradar-C_746997/metadata/kc_questions_map_original_kc.json')
    parser.add_argument('--write_path', type=str, help="Path to write the clustered KC questions map JSON file.", 
                        default='/home/xiongzj/myProjects/KCQRL-main/data/moocradar-C_746997/metadata/kc_clusters_hdbscan_original_kc.json')
