...
from trainer_CL_no_cluster_only_KC import Trainer
...
if __name__ == '__main__':
    ...
    parser.add_argument('--json_file_cluster_kc', type=str,
                        default="../data/moocradar-C_746997/metadata/kc_no_clusters_original_kc.json",
    ...
    parser.add_argument('--wandb_project_name', type=str,
                        default="KCQRL-moocradar-C_746997_CL-no-cluster_only-original-KC",
